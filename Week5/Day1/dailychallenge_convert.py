...
notebook_data = {
    "cells": [
        ...
        },
        {
            ...
            "source": ["data_z_score_normalization"],
        },
        {
            "cell_type": "markdown",
        ...
        },
        {
            ...
            "metadata": {},
            "outputs": [],
            "source": ["vector_matrix = np.ravel(data)"],
        },
        {
            "cell_type": "code",
            "execution_count": 46,
        ...
        },
        {
            ...
            "metadata": {},
            "outputs": [],
            "source": ["array_my = np.array(np.random.randint(1, 100, size=5))"],
        },
        {
            "cell_type": "code",
            "execution_count": 48,
            ...
            "outputs": [
                {
                    "data": {"text/plain": ["array([31, 80, 83, 27, 41])"]},
                    "execution_count": 48,
                    "metadata": {},
                    "output_type": "execute_result",
                }
        ...
        },
        {
            ...
            "metadata": {},
            "outputs": [],
            "source": ["array2 = np.array(np.random.randint(1, 100, size=5))"],
        },
        {
            "cell_type": "code",
            "execution_count": 50,
            ...
            "outputs": [
                {
                    "data": {"text/plain": ["array([68, 48, 37, 26, 30])"]},
                    "execution_count": 50,
                    "metadata": {},
                    "output_type": "execute_result",
                }
        ...
        },
        {
            ...
            "outputs": [
                {
                    "data": {"text/plain": ["10951"]},
                    "execution_count": 51,
                    "metadata": {},
                    "output_type": "execute_result",
                }
            ],
            "source": ["np.dot(array_my, array2)"],
        },
        {
            "cell_type": "markdown",
        ...
        },
        {
            ...
            "metadata": {},
            "outputs": [],
            "source": ["matrix_multiplication = np.dot(data[2:, 2:], data2)"],
        },
        {
            "cell_type": "code",
            "execution_count": 55,
        ...
        },
        {
            ...
            "metadata": {},
            "outputs": [],
            "source": ["identity_matrix_mult2 = identity_matrix * 2"],
        },
        {
            "cell_type": "code",
            "execution_count": 59,
        ...
        },
        {
            ...
            "source": ["np.linalg.inv(identity_matrix_mult2)"],
        },
        {
            "cell_type": "markdown",
        ...
        },
        {
            ...
            "metadata": {},
            "outputs": [],
            "source": ["eigenvalues, eigenvectors = np.linalg.eig(data[:3, :3])"],
        },
        {
            "cell_type": "code",
            "execution_count": 62,
        ...
        },
        {
            ...
            "metadata": {},
            "outputs": [],
            "source": ["mark = np.random.choice(data.size, 5)"],
        },
        {
            "cell_type": "code",
            "execution_count": 74,
            ...
            "outputs": [
                {
                    "data": {"text/plain": ["array([ 4, 21, 10,  4,  8])"]},
                    "execution_count": 74,
                    "metadata": {},
                    "output_type": "execute_result",
                }
        ...
        },
        {
            ...
            "metadata": {},
            "outputs": [],
            "source": ["data_matrix_copy = data[:].astype('float')"],
        },
        {
            "cell_type": "code",
            "execution_count": 76,
        ...
        },
        {
            ...
            "metadata": {},
            "outputs": [],
            "source": ["data_matrix_copy.flat[mark] = np.nan"],
        },
        {
            "cell_type": "code",
            "execution_count": 78,
        ...
        },
        {
            ...
            "outputs": [
                {
                    "data": {
                        "text/plain": ["(array([0, 1, 2, 4]), array([4, 3, 0, 1]))"]
                    },
                    "execution_count": 80,
                    "metadata": {},
                    "output_type": "execute_result",
...
with open("dailychal.ipynb", "w", encoding="utf-8") as f:
